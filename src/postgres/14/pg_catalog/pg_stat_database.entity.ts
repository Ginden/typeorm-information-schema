...
export class PgStatDatabase {
  ...
  public readonly sessions!: string | null /* int8 */;

  @ViewColumn({ name: 'sessions_abandoned' })
  public readonly sessions_abandoned!: string | null /* int8 */;

  @ViewColumn({ name: 'sessions_fatal' })
  public readonly sessions_fatal!: string | null /* int8 */;

  @ViewColumn({ name: 'sessions_killed' })
  public readonly sessions_killed!: string | null /* int8 */;
