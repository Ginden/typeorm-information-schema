...
export class PgStatWal {
  ...
  public readonly wal_records!: `${number}` | null /* int8 */;

  @ViewColumn({ name: 'wal_fpi' })
  public readonly wal_fpi!: `${number}` | null /* int8 */;

  @ViewColumn({ name: 'wal_bytes' })
  public readonly wal_bytes!: unknown | null /* numeric */;

  @ViewColumn({ name: 'wal_buffers_full' })
  public readonly wal_buffers_full!: `${number}` | null /* int8 */;

  @ViewColumn({ name: 'wal_write' })
  public readonly wal_write!: `${number}` | null /* int8 */;

  @ViewColumn({ name: 'wal_sync' })
  public readonly wal_sync!: `${number}` | null /* int8 */;
